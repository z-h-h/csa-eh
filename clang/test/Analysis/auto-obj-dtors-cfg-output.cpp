...
// CHECK:      [B0 (EXIT)]
// CHECK-NEXT:   Preds (4): B1 B3 B6 B10
void test_if_jumps() {
  A a;
  if (A b = a) {
    A c;
...
// CHECK-NEXT:   Succs (1): B0
// CHECK:      [B0 (EXIT)]
// CHECK-NEXT:   Preds (4): B2 B1 B3 B4
